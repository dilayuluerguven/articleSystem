    ...
    try {
      ...
      const [rows] = await db.promise().query(
        `
          ...
          LEFT JOIN ust_aktiviteler ua ON SUBSTRING_INDEX(b.aktivite, '-', 1) = ua.kod
      ...
      //Word içindeki verileri bağlama
      doc.render({
        yayin_kodu: data.aktivite_kod || data.ust_aktivite || "-",
        akademik_faaliyet:
          data.aktivite_tanim ||
          data.alt_tanim ||
          data.ust_tanim ||
