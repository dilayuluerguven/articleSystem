...
const initialCategories = [
  {
    ...
    subcategories: [
      {
        code: "M-1",
        description: "Derece (uluslararası / ulusal)",
        subcategories: [],
      },
      {
        code: "M-2",
        description: "Jüri özel ödülü (uluslararası / ulusal)",
        subcategories: [],
      },
      {
        code: "M-3",
        description: "Mansiyon (uluslararası / ulusal)",
        subcategories: [],
      },
      {
        code: "M-4",
        description: "Sergileme (uluslararası / ulusal)",
        subcategories: [],
      },
      {
        code: "M-5",
        description: "Satın alınmış proje (uluslararası / ulusal ",
        subcategories: [],
      },
      {
        code: "M-6",
...
export default function M_part() {
  ...
  const allowedCategoryCodes = ["M-1","M-2","M-3","M-4","M-5","M-6", "M-7","M-8",];
