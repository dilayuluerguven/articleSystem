...
const initialCategories = [
  {
    ...
    subcategories: [
      ...
      {
        code: "C-4",
        description: "Yabancı dile çevrilmiş kitap yazarlığı",
        subcategories: [
          {
            code: "C-4.1",
            description: "Yabancı dile kitap çeviri editörlüğü",
            subcategories: [],
          },
          {
            code: "C-4.2",
            description: "Yabancı dile kitap bölümü bölüm çevirisi",
            subcategories: [],
          },
        ],
      },
...
function CategoryItem({ category, onAddWork, onEditWork, setCategories }) {
  ...
  const allowedCategoryCodes = ["C-1", "C-2", "C-3", "C-4"];
