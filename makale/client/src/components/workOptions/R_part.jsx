...
const initialCategories = [
  {
    ...
    subcategories: [
      {
        code: "R-1",
        description: "Uluslararası bilim, sanat ödülü (Periyodik, Jürili)",
        subcategories: [],
      },
      {
        code: "R-2",
      ...
      {
        code: "R-3",
        description: "Uluslararası bilim, sanat ödülü",
        subcategories: [],
      },
      {
        code: "R-4",
        description: "Ulusal bilim, sanat ödülü",
        subcategories: [],
      },
    ],
  },
...
function CategoryItem({ category, onAddWork, onEditWork, setCategories }) {
  ...
  const allowedCategoryCodes = ["R-1", "R-2", "R-3", "R-4"];
