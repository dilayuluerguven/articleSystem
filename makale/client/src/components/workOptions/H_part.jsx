...
const initialCategories = [
  {
    ...
    subcategories: [
      ...
      {
        code: "H-2",
        description: "Tez savunma jüri üyelikleri Yüksek Lisans/Doktora",
        subcategories: [],
      },
      {
        code: "H-3",
        description: "Doktora Tez İzleme Komitesi Üyeliği",
        subcategories: [],
      },
      {
        code: "H-4",
...
function CategoryItem({ category, onAddWork, onEditWork, setCategories }) {
  ...
  const allowedCategoryCodes = ["H-1", "H-2", "H-3", "H-4"];
