...
const categories = [
    {
      code: "I",
      description: "I.Bilim İnsanı Yetiştirmeye Yönelik Çabalar ",
      subcategories: [
        {
          code: "I-1",
          description:
            "Danışmanlığında tamamlanmış Yabancı Dilde / Türkçe her bir yüksek lisans tezi ",
          subcategories: [
            { code: "I-1:1", description: "Çalışma-1" },
            { code: "I-1:2", description: "Çalışma-2" }
          ],
        },
        {
          code: "I-2",
          description:
            "Danışmanlığını yaptığı tamamlanmış Yabancı Dilde / Türkçe her bir doktora tezi",
          subcategories: [
            { code: "I-2:1", description: "Çalışma-1" },
            { code: "I-2:2", description: "Çalışma-2" },
          ],
        },
      ],
    },
...
export default function I_part() {
